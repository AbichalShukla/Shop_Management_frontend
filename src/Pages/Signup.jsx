...
export default function Signup() {
  ...
  try {
    ...
    console.log(response.data, "this is verify email");
if (response.data.success) {
  navigate("/verifyotp", { state: { email: response.data.email } });
}
      ...
      <div className="w-full max-w-md mx-4">
        <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500">Join BookSwap and start sharing books</p>
          </div>
          ...
          <div className="space-y-5">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-bold py-3 px-4 rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
              Sign Up
            </button>
          </div>
